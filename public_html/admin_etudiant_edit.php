...
if(isset($_POST['update'])) // when click on Update button
{
    ...
    $edit = mysqli_query($link,"update etudiant set nom='$nom', prenom='$prenom', email='$email', classement='$classement', filiere_id='$specialite' where id='$id'");
	
    if($edit)
    {
        mysqli_close($link); // Close connection
        header("Location:admin_etudiant.php"); // redirects to all records page
        exit;
    }
    else
    {
