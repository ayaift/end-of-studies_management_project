...
if(!empty($_POST['email'])){
  ...
  if(filter_var($email, FILTER_VALIDATE_EMAIL)) {
    ...
    $url = 'http://'.$_SERVER['SERVER_NAME'].'/univ-mosta.tech/public_html/prof/make_new_password.php?id='.$iddata.'&email='.$emaildata;
...
<div class="b-example-divider">
    ...
    <div class="container">
        <label for="uname"><b>Enter votre adresse mail</b></label>
