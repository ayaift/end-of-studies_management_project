...
if(mysqli_num_rows($select)) {
    ...
    header("location: /univ-mosta.tech/public_html/prof/inscription.php?result=".urlencode($result));
...
if($stmt = mysqli_prepare($link, $sql)){
    ...
    if(mysqli_stmt_execute($stmt)){
        ...
        $url = 'http://'.$_SERVER['SERVER_NAME'].'/univ-mosta.tech/public_html/prof/verify.php?id='.$last_id.'&token='.$token;
