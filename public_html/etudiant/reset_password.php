...
if(!empty($_POST['email'])){
  ...
  if(filter_var($email, FILTER_VALIDATE_EMAIL)) {
    ...
    $url = 'http://'.$_SERVER['SERVER_NAME'].'/univ-mosta.tech/public_html/etudiant/make_new_password.php?id='.$iddata.'&email='.$emaildata;

    $output = "<div>  merci de vous entrer sur ce lien pour changer votre mot de pass <br>".$url;
      ...
      <p>
        <?php  
          ...
          echo "$result";
            ...
            <label style=" margin-left: 30px; color: #111c30;"><h4>Récuperer  mot de passe</h4></label>
        </div>
