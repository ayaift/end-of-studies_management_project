...
if(isset($_POST['change'])){
  ...
  $newpass = mysqli_real_escape_string($link, md5($_POST['newpass']));
  $repass= mysqli_real_escape_string($link, md5($_POST['repass']));

  $select = mysqli_query($link, "SELECT * FROM etudiant WHERE id = '$id' AND email='$email' ");
  ...
  $password = mysqli_real_escape_string($link, md5($data['password']));
    ...
    if($newpass == $repass){
          ...
          $update = mysqli_query($link, "UPDATE etudiant SET password = '$newpass' WHERE id = '$id' AND email='$email' ");
    ...
    <div class="container" style="margin-bottom: 24px;padding-bottom: 0px;padding-top: 0px;">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom"style="margin-right: 0px;">
            <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
              ...
              <img src="logo.png" class="bi me-2" alt="" width="50" height="40">
...
<div class="b-example-divider">
    ...
    <div class="col-sm-12 col-sm-offset-4">
      <p>
        ...
        <label style="margin-left: 20px; color: #111c30;"><h4>Recuperer votre mot de passe</h4></label>
    ...
    <div class="container">
        ...
        <label for="uname"><b>Entrer votre nouveau mot de passe</b></label>
        <input type="password" placeholder="Entrer votre nouveau mot de passe" name="newpass" required>

        <label for="uname"><b>Confirmer votre nouveau mot de passe</b></label>
        <input type="password" placeholder="Confirmer votre nouveau mot de passe" name="repass" required>
        ...
        <div class="col-md-3 col-sm-6">
          ...
          <div class="footer-pad">
            ...
            <ul class="list-unstyled">
              <li><a href="#"></a></li>
              <li><a href="https://www.univ-mosta.dz">www.est.uit.ac.ma</a></li>
